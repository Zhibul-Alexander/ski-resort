...
function formatCustomerEmail(payload: BookingPayload) {
  ...
  lines.push("");
  lines.push(`Thank you for your interest in SKI HOUSE+!`);
  lines.push("");
...
<body>`);
  ...
  htmlParts.push(`<p>Thank you for your interest in SKI HOUSE+!</p>
  ...
  return {
    subject: `SKI HOUSE+ — Your ${getTypeLabel(payload.type)} Request Has Been Received`,
    text: lines.join("\n"),
    html: htmlParts.join("\n")
  };
}
